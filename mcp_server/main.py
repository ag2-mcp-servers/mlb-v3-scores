...
#   timestamp: 2025-06-29T09:38:50+00:00
...
@app.get(
    '/{format}/AllTeams',
    tags=['team_info_management', 'player_stats_retrieval'],
    security=[
...
@app.get(
    ...
    tags=['game_schedule_management', 'season_data_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['sports_news_updates', 'player_stats_retrieval'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    '/{format}/Players',
    tags=['player_stats_retrieval', 'team_info_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['season_data_management', 'game_schedule_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['team_info_management', 'season_data_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
